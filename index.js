...
const loadFile = async (file) => {
  ...
  //     for (const item of data) { await upload(item) }
...
const getFiles = async () => {
  return new Promise(async (res) => {
    ...
    const files = await fspromise.readdir('/home/aidbox/temp/messages/message export')

    for (const file of files) {
        const filePath = path.join('/home/aidbox/temp/messages/message export', file)
